python main_community.py --dataset amazon-ratings --res 'None' --epochs 1500 --batch_size 512 --min_q 0.6 --del_q 0.1 --runs 10 --metric acc --display_step 100
python main_community.py --dataset amazon-ratings --res 'None' --epochs 1500 --batch_size 512 --min_q 0.6 --del_q 0.1 --runs 10 --metric acc --display_step 100 --LPF 1

python main_community.py --dataset roman-empire --res 'None' --epochs 600 --batch_size 11600 --min_q 1.0 --del_q 0.1 --runs 10 --metric acc --display_step 100  --lr .01 --hidden_channels 792 --num_layers 3
python main_community.py --dataset roman-empire --res 'None' --epochs 600 --batch_size 11600 --min_q 1.0 --del_q 0.1 --runs 10 --metric acc --display_step 100  --lr .01 --hidden_channels 792 --num_layers 3 --LPF 1 --NF

python main_community.py --dataset cora --res 'none' --epochs 200 --hidden_channels 256  --batch_size 128  --min_q 0.1 --del_q 0.2  --train_prop 0.6 --valid_prop 0.2 --rand_split --runs 10 --display_step 100 --metric acc
python main_community.py --dataset cora --res 'none' --epochs 200 --hidden_channels 256  --batch_size 128  --min_q 0.1 --del_q 0.2  --train_prop 0.6 --valid_prop 0.2 --rand_split --runs 10 --display_step 100 --metric acc --NF --LPF 2

python main_community.py --dataset squirrel-filtered --res '0' --epochs 20 --hidden_channels 600 --batch_size 600 --num_layers 3 --dropout 0.8 --min_q .61 --del_q 0.05 --runs 10 --metric acc --display_step 3 --lr .005 --weight_decay 0
python main_community.py --dataset squirrel-filtered --res '0' --epochs 20 --hidden_channels 600 --batch_size 600 --num_layers 3 --dropout 0.8 --min_q .61 --del_q 0.05 --runs 10 --metric acc --display_step 3 --lr .005 --weight_decay 0 --LPF 2


python main_community.py --dataset chameleon-filtered --res 'none' --epochs 30 --batch_size 256 --num_layers 1 --dropout 0.5 --min_q 0.7 --del_q 0.1 --train_prop 0.6 --valid_prop 0.2 --runs 10 --metric acc --lr .001
...
python main_community.py --dataset tolokers --res '0.5 0.75 1 1.364' --epochs 2000 --batch_size 512 --dropout 0.5 --num_layers 2 --min_q 0.3 --del_q 0.1 --metric rocauc --runs 10 --display_step 100 --LPF 2 --NF

python main_community.py --dataset pubmed --res '0.5 1 1.956' --epochs 300 --batch_size 8000 --dropout 0.7 --num_layers 3 --min_q 0.7 --del_q 0.1 --metric acc --runs 10 --display_step 100  --train_prop 0.6 --valid_prop 0.2 --rand_split --lr .001

...
python main_community.py --dataset squirrel-filtered --res 'None' --comres 1 --epochs 300 --batch_size 128 --num_layers 0 --min_q 0.4 --del_q 0.1 --runs 10 --metric acc --display_step 100
python main_community.py --dataset chameleon-filtered --res 'None' --comres 1 --epochs 200 --batch_size 128 --num_layers 0 --dropout 0 --min_q 0.3 --del_q 0.1 --train_prop 0.6 --valid_prop 0.2 --runs 10 --metric acc
...
python main_community.py --dataset flickr --res 'None' --num_layer 3 --epochs 60 --batch_size 512 --runs 10 --min_q  0.2 --dropout .7 --lr .0001 --metric acc --del_q 0.2
